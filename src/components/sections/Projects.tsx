...
export const Projects = () => {
  return (
    <section id="projects" className="min-h-screen py-20 bg-background relative">
            ...
            <div className="grid md:grid-cols-2 gap-0">
               ...
               <div className="p-8 md:p-10 flex flex-col justify-center bg-surface">
                 <div className="flex items-center gap-2 mb-4">
                   ...
                   <span className="text-primary font-mono text-sm capitalize">Full Stack Application</span>
                 </div>
                 
                 <h3 className="text-3xl font-bold mb-4 group-hover:text-primary transition-colors">Vera</h3>
                 <p className="text-muted mb-6 leading-relaxed">
                   A modern full-stack task management application focused on simplicity and productivity. 
                   Features secure authentication, a focus dashboard, and a clean glassmorphism-based UI.
                 </p>
                 
                 <div className="mb-8">
                   <h4 className="text-sm font-semibold mb-3 text-gray-300">Tech Stack:</h4>
                   <div className="flex flex-wrap gap-2">
                     {["React", "TypeScript", "Node.js", "Express", "MongoDB", "Docker"].map(tech => (
                       <span key={tech} className="px-3 py-1 bg-white/5 text-xs text-gray-400 border border-white/5 rounded-full">
                         {tech}
                       </span>
                     ))}
                   </div>
               ...
               <div className="relative bg-gradient-to-br from-gray-900 to-black p-8 flex items-center justify-center min-h-[300px]">
                  <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-20 group-hover:opacity-30 transition-opacity duration-500" />
